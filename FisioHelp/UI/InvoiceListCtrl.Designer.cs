namespace FisioHelp.UI
{
  partial class InvoiceListCtrl
  {
    ...
    private void InitializeComponent()
    {
			...
			this.stsSent = new System.Windows.Forms.DataGridViewCheckBoxColumn();
			...
			// stsSent
			// 
			this.stsSent.HeaderText = "STS";
			this.stsSent.Name = "stsSent";
			this.stsSent.ReadOnly = true;
			this.stsSent.Width = 50;
			// 
			// toInvoice
			// 
    ...
    private System.Windows.Forms.CheckBox checkBox1;
		...
		private System.Windows.Forms.DataGridViewCheckBoxColumn stsSent;
